...
namespace DHT11 {
    ...
    /**
    * Query data from DHT11 sensor. If you are using 4 pins/no PCB board versions, you'll need to pull up the data pin. 
    * It is also recommended to wait 1 second between each query.
    */
    //% block="Query1 Data pin $dataPin"
    ...
    /**
    * Read humidity/temperature data from lastest query of DHT11
    */
    //% block="Read $data"
